...
documents = SimpleDirectoryReader(input_files=["/Users/paavnisingh/govt-pol/LaQshay.pdf"]).load_data()
...
summary_tool = QueryEngineTool.from_defaults(
    ...
    description=(
        """Useful for summarization questions related to LaQshay policy from multiple papers.
...
vector_tool = QueryEngineTool.from_defaults(
    ...
    description=(
        "Useful for retrieving specific context from the LaQshay policy from multiple papers"
    ),
)
